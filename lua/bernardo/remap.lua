...
vim.keymap.set("n", "<leader>fsh", telescope_builtin.search_history, { desc = "Lista o histórico de buscas" })
...
vim.keymap.set('n', '<leader>gsa', gitsigns.stage_buffer, { desc = "Adiciona todas as alterações do buffer ao stage" })
